...
return [
    ...
    'cards' => [
        ['id' => 'invalidate-argument', 'title' => 'Invalidate Argument', 'usage' => "Counter your opponent's argument with a spoon. It doesn't have to make sense. That's the point.", 'emoji' => '🥄', 'ptype' => 'psychic', 'mtype' => 'blue', 'pwr' => 7, 'wit' => 9, 'chs' => 4, 'fullArt' => true, 'animated' => false, 'hue' => 285, 'hue2' => 220],
        ...
        ['id' => 'deploy-on-friday', 'title' => 'Deploy on Friday', 'usage' => 'Sacrifice your weekend. Deal 10 chaos damage to production. Cannot be countered.', 'emoji' => '🚀', 'ptype' => 'electric', 'mtype' => 'black', 'pwr' => 2, 'wit' => 4, 'chs' => 10, 'fullArt' => false, 'animated' => true, 'hue' => 48, 'hue2' => 10],
        ...
        ['id' => 'touch-grass', 'title' => 'Touch Grass', 'usage' => 'Force target player to log off. They may return after one (1) sunlight.', 'emoji' => '🌱', 'ptype' => 'grass', 'mtype' => 'green', 'pwr' => 5, 'wit' => 6, 'chs' => 3, 'fullArt' => false, 'animated' => false, 'hue' => 110, 'hue2' => 150],
        ...
        ['id' => 'task-failed-successfully', 'title' => 'Task Failed Successfully', 'usage' => 'Whenever you would lose, win instead, but worse.', 'emoji' => '✅', 'ptype' => 'normal', 'mtype' => 'colorless', 'pwr' => 1, 'wit' => 7, 'chs' => 8, 'fullArt' => false, 'animated' => true, 'hue' => 160, 'hue2' => 120],
        ...
        ['id' => 'side-eye', 'title' => 'The Side Eye', 'usage' => "Silently reduce target's credibility to zero. No words required.", 'emoji' => '👀', 'ptype' => 'psychic', 'mtype' => 'black', 'pwr' => 5, 'wit' => 9, 'chs' => 4, 'fullArt' => false, 'animated' => true, 'hue' => 300, 'hue2' => 260],
        ['id' => 'blocked-and-reported', 'title' => 'Blocked & Reported', 'usage' => 'Banish target from the conversation. They were never here.', 'emoji' => '🚫', 'ptype' => 'fighting', 'mtype' => 'white', 'pwr' => 9, 'wit' => 2, 'chs' => 3, 'fullArt' => false, 'animated' => false, 'hue' => 355, 'hue2' => 320],
        ['id' => 'crying-in-the-club', 'title' => 'Crying in the Club', 'usage' => 'Take 2 emotional damage. The beat drops anyway.', 'emoji' => '😭', 'ptype' => 'water', 'mtype' => 'blue', 'pwr' => 2, 'wit' => 6, 'chs' => 7, 'fullArt' => true, 'animated' => true, 'hue' => 205, 'hue2' => 250],
        ['id' => 'popcorn-time', 'title' => 'Popcorn Time', 'usage' => 'You are not involved. You are simply here for the drama. Draw 3 cards.', 'emoji' => '🍿', 'ptype' => 'grass', 'mtype' => 'white', 'pwr' => 3, 'wit' => 7, 'chs' => 5, 'fullArt' => false, 'animated' => false, 'hue' => 45, 'hue2' => 20],
        ...
        ['id' => 'get-ratioed', 'title' => 'Ratio', 'usage' => 'Your reply now outweighs the original post. Math is undefeated.', 'emoji' => '📉', 'ptype' => 'electric', 'mtype' => 'blue', 'pwr' => 7, 'wit' => 5, 'chs' => 6, 'fullArt' => false, 'animated' => false, 'hue' => 200, 'hue2' => 160],
        ['id' => 'kinda-sus', 'title' => 'Kinda Sus', 'usage' => 'Accuse target player. If wrong, eject yourself. If right, eject them anyway.', 'emoji' => '🕵️', 'ptype' => 'ghost', 'mtype' => 'black', 'pwr' => 4, 'wit' => 7, 'chs' => 9, 'fullArt' => false, 'animated' => true, 'hue' => 0, 'hue2' => 260],
        ['id' => 'certified-bruh', 'title' => 'Certified Bruh Moment', 'usage' => 'Stare into the middle distance. All stats become 5. Bruh.', 'emoji' => '😐', 'ptype' => 'normal', 'mtype' => 'colorless', 'pwr' => 5, 'wit' => 5, 'chs' => 5, 'fullArt' => true, 'animated' => false, 'hue' => 220, 'hue2' => 200],
    ],
];
